...
<body>
<form action="betweenad.php" method="POST">
<label for="event">Admission During Dates</label><input type="date" name="fromdate"> To <input type="date" name="todate"> <br><br>
...
$query="select * from admission where admission_date between '$from' and '$to'";
$r=pg_query($conn,$query) or die("problem in query");
$result=pg_num_rows($r);
if($result==0)
{
echo "<font size='10px'>Sryyy!!! There is no admission in the given period...plzz enter valid date</font>";
}
else
{
$q2="select * from admission where admission_date between '$from' and '$to'";
$r1=pg_query($conn,$q2);
if($r1!=null)
{
